...
class Values
{
     ...
     */
    public static function ethnicityValues(): array
    {
        return [
            'Afghan' => 'OAFG',
            'African Asian' => 'AAFR',
     ...
     * @return array<int,string>
     */
    public static function nationalityValues(): array
    {
        return [
     ...
     * @return string
     */
    public static function validEthnicity(string $value): string
    {
        ...
        foreach (self::ethnicityValues() as $description => $code) {
            if ($key === self::matchKey($description)) {
                return $description;
            }

            if ($code !== null
                && ($key === self::matchKey($code) || $key === self::matchKey($description . $code))
            ) {
                return $description;
            }
        }
     ...
     * @return string
     */
    public static function validNationality(string $value): string
    {
        return self::matchFromList($value, self::nationalityValues());
    }
     ...
     * @return string
     */
    public static function validSend(string $value): string
    {
        return self::matchFromList($value, self::sendValues());
    }
     ...
     */
    public static function matchFromList(string $value, array $list): string
    {
        $key = self::matchKey($value);
