...
UPDATE `gibbonAction` SET `URLList`='academicRecords_courseCredits.php,academicRecords_courseCreditsProcess.php,academicRecords_courseCreditsCopyProcess.php' WHERE `name`='Course Credits' AND `gibbonModuleID`=(SELECT gibbonModuleID FROM gibbonModule WHERE name='Academic Records');end
UPDATE `gibbonAction` SET `name`='View Academic Records_all', `precedence`=2, `description`='View the academic record of any student.' WHERE `name`='View Academic Records' AND `gibbonModuleID`=(SELECT gibbonModuleID FROM gibbonModule WHERE name='Academic Records');end
DELETE FROM `gibbonPermission` WHERE `gibbonRoleID`='002' AND `gibbonActionID`=(SELECT gibbonActionID FROM gibbonAction WHERE `name`='View Academic Records_all' AND `gibbonModuleID`=(SELECT gibbonModuleID FROM gibbonModule WHERE name='Academic Records'));end
INSERT INTO `gibbonAction` (`gibbonModuleID`, `name`, `precedence`, `category`, `description`, `URLList`, `entryURL`, `entrySidebar`, `menuShow`, `defaultPermissionAdmin`, `defaultPermissionTeacher`, `defaultPermissionStudent`, `defaultPermissionParent`, `defaultPermissionSupport`, `categoryPermissionStaff`, `categoryPermissionStudent`, `categoryPermissionParent`, `categoryPermissionOther`) SELECT (SELECT gibbonModuleID FROM gibbonModule WHERE name='Academic Records'), 'View Academic Records_my', 1, 'View', 'View the academic record of a student in a class the user teaches or a form group the user tutors.', 'academicRecords_view.php', 'academicRecords_view.php', 'Y', 'Y', 'N', 'Y', 'N', 'N', 'N', 'Y', 'N', 'N', 'N' FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM (SELECT * FROM gibbonAction) AS held WHERE held.name='View Academic Records_my' AND held.gibbonModuleID=(SELECT gibbonModuleID FROM gibbonModule WHERE name='Academic Records'));end
INSERT INTO `gibbonPermission` (`gibbonRoleID`, `gibbonActionID`) SELECT '002', `gibbonAction`.`gibbonActionID` FROM `gibbonAction` WHERE `gibbonAction`.`gibbonModuleID`=(SELECT gibbonModuleID FROM gibbonModule WHERE name='Academic Records') AND `gibbonAction`.`name`='View Academic Records_my' AND NOT EXISTS (SELECT 1 FROM (SELECT * FROM `gibbonPermission`) AS `held` WHERE `held`.`gibbonActionID`=`gibbonAction`.`gibbonActionID` AND `held`.`gibbonRoleID`='002');end
INSERT INTO `gibbonAction` (`gibbonModuleID`, `name`, `precedence`, `category`, `description`, `URLList`, `entryURL`, `entrySidebar`, `menuShow`, `defaultPermissionAdmin`, `defaultPermissionTeacher`, `defaultPermissionStudent`, `defaultPermissionParent`, `defaultPermissionSupport`, `categoryPermissionStaff`, `categoryPermissionStudent`, `categoryPermissionParent`, `categoryPermissionOther`) SELECT (SELECT gibbonModuleID FROM gibbonModule WHERE name='Academic Records'), 'Stored Grade Coverage', 1, 'Manage', 'Shows which classes have a stored grade for each term of a school year.', 'academicRecords_coverage.php', 'academicRecords_coverage.php', 'Y', 'Y', 'Y', 'N', 'N', 'N', 'Y', 'Y', 'N', 'N', 'N' FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM (SELECT * FROM gibbonAction) AS held WHERE held.name='Stored Grade Coverage' AND held.gibbonModuleID=(SELECT gibbonModuleID FROM gibbonModule WHERE name='Academic Records'));end
INSERT INTO `gibbonPermission` (`gibbonRoleID`, `gibbonActionID`) SELECT '001', `gibbonAction`.`gibbonActionID` FROM `gibbonAction` WHERE `gibbonAction`.`gibbonModuleID`=(SELECT gibbonModuleID FROM gibbonModule WHERE name='Academic Records') AND `gibbonAction`.`name`='Stored Grade Coverage' AND NOT EXISTS (SELECT 1 FROM (SELECT * FROM `gibbonPermission`) AS `held` WHERE `held`.`gibbonActionID`=`gibbonAction`.`gibbonActionID` AND `held`.`gibbonRoleID`='001');end
INSERT INTO `gibbonPermission` (`gibbonRoleID`, `gibbonActionID`) SELECT '006', `gibbonAction`.`gibbonActionID` FROM `gibbonAction` WHERE `gibbonAction`.`gibbonModuleID`=(SELECT gibbonModuleID FROM gibbonModule WHERE name='Academic Records') AND `gibbonAction`.`name`='Stored Grade Coverage' AND NOT EXISTS (SELECT 1 FROM (SELECT * FROM `gibbonPermission`) AS `held` WHERE `held`.`gibbonActionID`=`gibbonAction`.`gibbonActionID` AND `held`.`gibbonRoleID`='006');end";

// v0.7.00
$count++;
$sql[$count][0] = "0.7.00";
$sql[$count][1] = "INSERT INTO `gibbonAction` (`gibbonModuleID`, `name`, `precedence`, `category`, `description`, `URLList`, `entryURL`, `entrySidebar`, `menuShow`, `defaultPermissionAdmin`, `defaultPermissionTeacher`, `defaultPermissionStudent`, `defaultPermissionParent`, `defaultPermissionSupport`, `categoryPermissionStaff`, `categoryPermissionStudent`, `categoryPermissionParent`, `categoryPermissionOther`) SELECT (SELECT gibbonModuleID FROM gibbonModule WHERE name='Academic Records'), 'Import Historic Grades', 1, 'Manage', 'Imports grades from a spreadsheet for the years before Gibbon was in use.', 'academicRecords_historicImport.php', 'academicRecords_historicImport.php', 'Y', 'Y', 'Y', 'N', 'N', 'N', 'N', 'Y', 'N', 'N', 'N' FROM DUAL WHERE NOT EXISTS (SELECT 1 FROM (SELECT * FROM gibbonAction) AS held WHERE held.name='Import Historic Grades' AND held.gibbonModuleID=(SELECT gibbonModuleID FROM gibbonModule WHERE name='Academic Records'));end
INSERT INTO `gibbonPermission` (`gibbonRoleID`, `gibbonActionID`) SELECT '001', `gibbonAction`.`gibbonActionID` FROM `gibbonAction` WHERE `gibbonAction`.`gibbonModuleID`=(SELECT gibbonModuleID FROM gibbonModule WHERE name='Academic Records') AND `gibbonAction`.`name`='Import Historic Grades' AND NOT EXISTS (SELECT 1 FROM (SELECT * FROM `gibbonPermission`) AS `held` WHERE `held`.`gibbonActionID`=`gibbonAction`.`gibbonActionID` AND `held`.`gibbonRoleID`='001');end";
